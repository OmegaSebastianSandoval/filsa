		...
		<div class="content-dashboard">
			...
			<div class="row">
				...
				<div class="col-6 form-group">
					...
					<div class="help-block with-errors"></div>
					<?php if ($this->content->documento_documento) { ?>
						<div id="archivo_documento_documento">
							<div><?php echo $this->content->documento_documento; ?></div>
							<div><button class="btn btn-danger btn-sm" type="button" onclick="eliminararchivo('documento_documento','<?php echo $this->route . "/deletearchivo"; ?>')"><i class="glyphicon glyphicon-remove"></i> Eliminar Archivo</button></div>
						</div>
					<?php } ?>
				</div>
