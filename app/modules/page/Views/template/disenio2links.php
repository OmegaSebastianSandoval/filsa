<?php if ($contenido->contenido_enlace) { ?>
	<a data-aos="" id="link-<?php echo $contenido->contenido_id; ?>" href="<?php echo $contenido->contenido_enlace; ?>" class="enlace-link" <?php if ($contenido->contenido_enlace_abrir == 1) { ?> target="blank" id="enlace-<?php echo $contenido->contenido_id; ?>"
		<?php } ?>>
	<?php } ?>
