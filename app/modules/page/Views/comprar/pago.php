                ...
                <section class="resume shadow mt-2 mt-lg-0">
                    ...
                    <div class="resume-content">
                        ...
                        <div class="resume-item d-flex justify-content-between align-items-center my-2 border-bottom">
                            ...
                            <span class="w-75 text-end info"> <?=  mb_convert_encoding($this->pedido->departamento_nombre, 'ISO-8859-1', 'UTF-8') . ", " .
                                                                  mb_convert_encoding($this->pedido->ciudad_nombre, 'ISO-8859-1', 'UTF-8') . ", " .
